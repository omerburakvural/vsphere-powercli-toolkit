# Script      : Recover-VM.ps1
# Author      : Burak Vural
# Description : DR/recovery helper blocks for storage, inventory and RDM operations.
# You can make this script more comprehensive by adding more features to it.
